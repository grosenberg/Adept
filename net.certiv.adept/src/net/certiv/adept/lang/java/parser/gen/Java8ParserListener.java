...
public interface Java8ParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link Java8Parser#classTypeList}.
	 * @param ctx the parse tree
	 */
	void enterClassTypeList(Java8Parser.ClassTypeListContext ctx);
	/**
	 * Exit a parse tree produced by {@link Java8Parser#classTypeList}.
	 * @param ctx the parse tree
	 */
	void exitClassTypeList(Java8Parser.ClassTypeListContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link Java8Parser#baseType}.
	 * @param ctx the parse tree
	 */
	void enterBaseType(Java8Parser.BaseTypeContext ctx);
	/**
	 * Exit a parse tree produced by {@link Java8Parser#baseType}.
	 * @param ctx the parse tree
	 */
	void exitBaseType(Java8Parser.BaseTypeContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link Java8Parser#arrayAccessExpression}.
	 * @param ctx the parse tree
	 */
	void enterArrayAccessExpression(Java8Parser.ArrayAccessExpressionContext ctx);
	/**
	 * Exit a parse tree produced by {@link Java8Parser#arrayAccessExpression}.
	 * @param ctx the parse tree
	 */
	void exitArrayAccessExpression(Java8Parser.ArrayAccessExpressionContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link Java8Parser#instanceCreationExpression}.
	 * @param ctx the parse tree
	 */
	void enterInstanceCreationExpression(Java8Parser.InstanceCreationExpressionContext ctx);
	/**
	 * Exit a parse tree produced by {@link Java8Parser#instanceCreationExpression}.
	 * @param ctx the parse tree
	 */
	void exitInstanceCreationExpression(Java8Parser.InstanceCreationExpressionContext ctx);
	/**

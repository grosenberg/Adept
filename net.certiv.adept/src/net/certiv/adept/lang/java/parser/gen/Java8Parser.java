...
public class Java8Parser extends Parser {
	...
	public static final int
		...
		URSHIFT_ASSIGN=101, Identifier=102, AT=103, ELLIPSIS=104, HWS=105, VWS=106, 
	...
	private static final String[] _SYMBOLIC_NAMES = {
		...
		"AT", "ELLIPSIS", "HWS", "VWS", "BLOCKCOMMENT", "LINECOMMENT"
	};
	...
	public static class TypeContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof Java8ParserListener ) ((Java8ParserListener)listener).enterType(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof Java8ParserListener ) ((Java8ParserListener)listener).exitType(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof Java8ParserVisitor ) return ((Java8ParserVisitor<? extends T>)visitor).visitType(this);
			else return visitor.visitChildren(this);
		}
	}

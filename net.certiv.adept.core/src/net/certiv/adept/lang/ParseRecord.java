...
public class ParseRecord {
	...
	public HashMultimap<Integer, Integer> align_pair;	// initialized from ALIGN_PAIR

	// ---------------------------------------------------------

	// key=token; value=feature
	public HashBiMap<Token, Feature> tokenFeatureIndex;
	...
	public ParseRecord(Document doc) {
		super();
		this.doc = doc;
		tokenFeatureIndex = HashBiMap.create();
		typeSet = new HashSet<>();
	...
	public List<Feature> getFeatures() {
		return new ArrayList<>(tokenFeatureIndex.values());
	}

...
public class MathUtils {
	 ...
	 * 20% chance of being rounded down to 0 and a 80% chance of being rounded up to 1). In the
	 * limit, the average of the rounded numbers generated by this procedure should converge to the
	 * original double.
	 *
	 * @param value the double value

...
import net.certiv.adept.vis.graph.components.FeaturePanel;
import net.certiv.adept.vis.graph.components.SimularityPanel;
import net.certiv.adept.vis.graph.models.DocTableModel;
import net.certiv.adept.vis.graph.models.MatchesTableModel;
import net.certiv.adept.vis.graph.models.SourceListModel;
import net.certiv.adept.vis.graph.models.SourceListModel.Item;
import net.certiv.adept.vis.graph.renderers.AlignCellRenderer;

...
import net.certiv.adept.view.components.SliderDialog;
import net.certiv.adept.view.components.TextLineNumber;
import net.certiv.adept.view.components.TreeViewer;
import net.certiv.adept.view.models.TokenTableModel;

public class ParseTreeView extends AbstractViewBase {
	...
	void createData(File file) {
		...
		ParseRecord data = doc.getParseRecord();
